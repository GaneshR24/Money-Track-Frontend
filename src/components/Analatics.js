...
const Analatics = ({ transactions }) => {
  ...
  const totalBalance =
    ((totalIncomeTurnover - totalExpenseTurnover) / totalIncomeTurnover) * 100;
          ...
          <div className="col-md-4 mt-3">
            <div className="transactions-count">
              ...
              <h5 className="d-flex justify-content-between">
                <span>Income : ₹ {totalIncomeTurnover}</span>
                <span>Expense : ₹ {totalExpenseTurnover}</span>
              </h5>
              <h5>Cash in Hand and Bank : ₹ {totalIncomeTurnover - totalExpenseTurnover}</h5>
              ...
              <div className="progress-bars">
                <Progress
                  ...
                  strokeColor="#5DD64F"
                  type="circle"
                  percent={totalBalance.toFixed(0)}
                />
              </div>
            </div>
          </div>
